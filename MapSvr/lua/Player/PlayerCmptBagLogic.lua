...
---@param callFrom string
function PlayerCmptBag:ByOtherCmptCallTest(callFrom)
    Log:Error("PlayerCmptBag:ByOtherCmptCallTest playerId %s callFrom %s", self:GetPlayer():GetPlayerID(), callFrom)
end
